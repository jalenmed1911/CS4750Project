...
"""The valuation function below is a first draft, and this file tests
   out how the different, somewhat arbitrarily chosen coefficients
   produce varying mean and median valuations for each position"""
