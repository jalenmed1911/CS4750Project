<?php
    ...
    //Go_To_Create_Account: Invoked when the login.php page tries to redirect the user to the createAccount.php page
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['Go_To_Create_Account'])) {
        header("Location: createAccount.php");
        exit();
    }

    //Account creation: invoked when the createAccount.php tries to create a new account
